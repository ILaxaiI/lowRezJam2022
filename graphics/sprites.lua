local ln = love.graphics.newImage
local sprites = {
    antimatter_round = ln("graphics/antimatter_round.png"),
    asteroid = ln("graphics/asteroid.png"),
    energy_shield_barrel = ln("graphics/Energy_Shield_Barrel.png"),
    energy_shield_head = ln("graphics/Energy_Shield_Head.png"),
    energy_shield = ln("graphics/Energy_Shield.png"),
    explosion = ln("graphics/explosion.png"),
    ...
    radiation = ln("graphics/radiation.png"),
